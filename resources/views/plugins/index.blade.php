...
@section('content')
    ...
    <div class="bg-white pb-4 px-4 rounded-md w-full flex">
        <div id="categories" class="w-1/6 border-solid border border-gray-200">
        ...
        <div id="plugin-index" class="w-5/6 border-solid border border-gray-200">
