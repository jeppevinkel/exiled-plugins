            ...
            <div class="flex flex-col w-full pt-6">
                ...
                <div class="flex flex-col m-4 mt-1">
                    <div class="flex justify-between">
                        ...
                        <p class="font-hairline text-gray-400">({{ \App\Plugin::count() }})</p>
                    </div>
                    @foreach(\App\Category::withCount('plugins')->get() as $category)
                        <div class="flex justify-between">
                            ...
                            <p class="font-hairline text-gray-400">({{ $category->plugins_count }})</p>
                        </div>
                    @endforeach
                </div>
            </div>
                            ...
                            <tr class="hover:bg-gray-700 border-b border-gray-200 py-10">
                                ...
                                <td class="flex flex-col px-4 py-4">
                                    <div class="flex justify-between text-xs">
                                        <p>Downloads:</p>
                                        <p>{{ array_sum($plugin->releases()->pluck('downloads')->toArray()) }}</p>
                                    </div>
                                    <div class="flex justify-between text-xs mt-1">
                                        ...
                                        <div class="flex justify-between text-xs mt-1">
                                            <p>EXILED Version:</p>
                                            <p>{{ $plugin->releases()->latest()->first()->exiled_version ?? 'No releases' }}</p>
                                        </div>
                                </td>
                            </tr>
                        @endforeach
